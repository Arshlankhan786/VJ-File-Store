...
BOT_USERNAME = environ.get("BOT_USERNAME", "Testing_pathan_bot") # without @
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1001984237226"))
...
WEBSITE_URL = environ.get("WEBSITE_URL", "https://testsamplepathan.blogspot.com/2024/07/pathan-botz.html") # For More Information Check Video On Yt - @Tech_VJ
